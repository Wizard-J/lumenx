            ...
            {headerOverride ?? (
                <div className="flex items-center gap-2 px-3 py-1.5">
                    ...
                    >
                        ...
                        <span className="font-mono text-[9.5px] font-medium uppercase tracking-[0.16em] text-text-muted">
                            {title}
                        </span>
                        {subtitle ? (
                            <span className="truncate font-mono text-[9.5px] tracking-tight text-text-muted/80">
                                {subtitle}
                            </span>
                        ) : null}
                    </button>
