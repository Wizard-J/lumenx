---
name: "source-command-lumenx-model-onboarding"
description: "LumenX 模型接入与文档更新流程 - 厂商文档抓取、model_catalog 更新、运行时范围判断、端到端验证"
---

# source-command-lumenx-model-onboarding

Use this skill when the user asks to run the migrated source command `lumenx-model-onboarding`.
